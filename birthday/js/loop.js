...
const THOUGHT_SCENE = (()=>{
  ...
  g(['crystalcave','tarotparlor','enchantedforest','wizardtower','fortuneteller','runecircle','arcanelibrary','fairyring','alchemylab','witchcottage','moontemple','willowispmarsh','enchantedmirrorhall','potionkitchen','crystalgrotto','potionlab','spiritshrine','shadowtheater'], ['🔮','✨','🌙']);
  return map;
})();
let thoughtTimer = 7;
