...
(function registerSpriteObjectPack1(){
  ...
  const assets={
    ...
    umbrella:    {src:base+'umbrella.png',cols:4,fps:0,defaultSize:65},
    ...
    floweringBush: {src:base+'flowering-bush.png',cols:4,fps:2.5,defaultSize:82,phase:'ground',anchorX:.5,anchorY:.89,footprint:{width:60,depth:18},depthOffset:0},
    ...
    grassTuft:     {src:base+'grass-tuft.png',cols:4,fps:3,defaultSize:52,phase:'ground',anchorX:.51,anchorY:.91,footprint:{width:36,depth:10},depthOffset:0},
