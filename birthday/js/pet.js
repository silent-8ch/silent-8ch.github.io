...
const SCENE_SPOTS = {
  ...
  tarotparlor: [
    {nx:0.50, ny:0.56, r:52, e:'🃏', lines:['The tarot cards 🃏','Turn one over? 🔮','I see love in our future 💗','The Lovers card! 💕','What story do they tell?']},
    {nx:0.68, ny:0.52, r:46, e:'🔮', lines:['The crystal ball 🔮','Swirling with light ✨','What does it see? 🥰','I see us together 💜','So many swirling colors!']},
    {nx:0.32, ny:0.46, r:44, e:'🕯️', lines:['The candelabra 🕯️','Flickering warmly','So atmospheric 💛','The flames dance for us 🔥']},
    {nx:0.50, ny:0.18, r:48, e:'♈', lines:['A zodiac wheel ♈','Which sign is yours? ✨','Written in the stars 🌟','Our signs align perfectly 💫']},
    {nx:0.16, ny:0.72, r:44, e:'🧪', lines:['A glowing potion 🧪','Bubbling green and bright ✨','A love potion maybe? 💚','Smells like wildflowers 🌸']},
    {nx:0.72, ny:0.24, r:44, e:'🔮', lines:['A crystal pendulum 🔮','Swinging back and forth ✨','It knows the answer 💜','Hypnotic and dreamy 🌙']},
    {nx:0.92, ny:0.42, r:40, e:'📿', lines:['Beaded curtain 📿','So sparkly and pretty ✨','A doorway to mystery 🌟','Each bead catches the light 💎']},
  ],
  enchantedforest: [
    {nx:0.12, ny:0.78, r:50, e:'🍄', lines:['Glowing mushrooms! 🍄','So purple and magical','A fairy\'s umbrella 🧚','They pulse with light! ✨']},
    {nx:0.34, ny:0.60, r:44, e:'🚪', lines:['A tiny fairy door 🚪','Someone lives inside! ✨','Knock knock? 🥰','I hear tiny footsteps! 🧚']},
    {nx:0.72, ny:0.62, r:46, e:'🏮', lines:['An old stone lantern 🏮','Glowing green and gentle','Who lit this one? 💚','Ancient forest magic 🌿']},
    {nx:0.50, ny:0.30, r:55, e:'✨', lines:['Floating lights ✨','Like tiny spirits 🧚','The forest is alive 💜','Will-o\'-wisps! 🌟']},
    {nx:0.25, ny:0.72, r:42, e:'💎', lines:['A glowing crystal! 💎','Purple and pulsing ✨','It hums with energy 💜','Touch it and feel the warmth 🌟']},
    {nx:0.58, ny:0.74, r:42, e:'💎', lines:['A blue crystal 💎','Cool light radiates out ✨','Like frozen starlight 🌙','So pretty embedded in the moss 💙']},
    {nx:0.45, ny:0.86, r:48, e:'🌿', lines:['The winding path 🌿','Where does it lead? ✨','Into the deeper woods 🌲','An adventure awaits us 💚','Follow the magic 🧚']},
  ],
  crystalgrotto: [
  ...
  starpool: [
    {nx:0.50, ny:0.60, r:62, e:'🌙', lines:['The reflections in the water 🌙','I can see the stars below us','Like a window into the sky ✨']},
    {nx:0.82, ny:0.10, r:48, e:'🌙', lines:['The crescent moon 🌙','So soft and silver','It\'s watching over us 🥰']},
    {nx:0.50, ny:0.70, r:50, e:'🕯️', lines:['A floating candle 🕯️','So warm on the water','Like a little wish light ✨']},
    {nx:0.06, ny:0.40, r:46, e:'🏛️', lines:['The ancient column 🏛️','How old must it be?','Covered in moss and stories 💛']},
    {nx:0.50, ny:0.36, r:52, e:'✨', lines:['A firefly! ✨','Dancing above the pool','So gentle and bright 🥰']},
  ],
  enchantedclock: [
    {nx:0.50, ny:0.28, r:56, e:'⏰', lines:['The giant clock face ⏰','The hands are turning slowly','What time is it in magic? ✨']},
    {nx:0.50, ny:0.58, r:54, e:'🔔', lines:['The pendulum swings 🔔','Back and forth, so steady','Hypnotizing… 🥰']},
